...
package object parser {
  ...
  /*alphaNum: parsea exitosamente cualquier cosa que letter o digit parseen exitosamente,
  devolviendo el mismo resultado que esos parsers. En cualquier otro caso falla.*/
